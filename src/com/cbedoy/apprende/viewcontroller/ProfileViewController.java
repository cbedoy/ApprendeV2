...
public class ProfileViewController extends AbstractViewController implements IProfileRepresentationHandler, IRankRepresentationHandler, NavigationBar.INavigationBarDelegate {
    ...
    public void showProfileViewWithData(HashMap<String, Object> userInformation) {
        ...
        Bitmap aux = BlurService.getInstance().performRequestBlurByImage(user_avatar_image);
        Bitmap user_avatar_blur = BlurService.getInstance().performRequestBlurByImage(aux);
    ...
    public void showPreviewViewController() {
        ...
        this.appViewManager.statusByLeftMenu(true);
    }
